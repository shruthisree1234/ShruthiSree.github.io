...
<div style="margin-bottom: 30px;">
  <a href="https://github.com/shruthisree1234/SaaS_Churn_Prediction" style="text-decoration: none; color: inherit; display: block;">
    <div style="border: 1px solid #ddd; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.1); transition: transform 0.2s;">
      <img src="/images/churn-rate-1.jpg" alt="SaaS Churn Prediction" style="width: 100%; display: block;" />
